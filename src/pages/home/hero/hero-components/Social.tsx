...
const Social = () => {
  ...
  return (
    <div className="social-body w-15 h-70 absolute bg-gradient-to-tr from-sky-400 to-purple-800 backdrop-blur-md top-[5%] right-10 rounded-2xl flex justify-center items-center z-50"
    ref={container}>
